import { Card, Text, Button, Row, Divider, User, Badge } from "@nextui-org/react";
                ...
                <Card css={{ height: "max-content", mw: "800px", mr: 10, mb: 10 }}>
                    <Card.Header css={{ flexDirection: "column" }}>
                        <Row css={{ justifyContent: "space-between" }}>
                            ...
                            {datapack.deleted && (
                                <Badge color="error" variant="flat" css={{ ml: "auto" }}>
                                    Pending Deletion
                                </Badge>
                            )}
                        </Row>
                    ...
                    <Card.Header css={{ justifyContent: "center", flexDirection: "column" }}>
                        ...
                        {datapack.isOwner || isModerator ? (
                            <Row css={{ justifyContent: "center", mt: 10 }}>
                                ...
                                {datapack.deleted && isModerator ? (
                                    <Button size={"xs"} color="success" icon={<TrashIcon width={18} />} onClick={handleDelete}>
                                        Undo
                                    </Button>
                                ) : (
