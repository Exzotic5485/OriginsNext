            ...
            <Grid.Container gap={2} justify="center" css={{ mt: 10 }}>
                ...
                <Grid xs={24} sm={6} direction="column">
                    ...
                    {datapacks.map((datapack) => {
                        return <Datapack name={datapack.title} description={datapack.description} imageSrc={`/uploads/datapack/${datapack.image}`} slug={datapack.slug} author={datapack.owner?.username} summary={datapack.summary} downloads={datapack.downloads} likes={datapack.likes} key={uuidv4()} />;
                    })}
                </Grid>
            </Grid.Container>
            <Row justify="center">
